...
??????not sure why this is plotting wrong. 2040 is definitely higher than 2020
```{r, warning = FALSE, message = FALSE}
...
ggplot() +
  ...
  labs(title = "Development Potential, 2040: Albemarle") + mapTheme +
...
ggplot() +
  ...
  scale_colour_manual(values = c("black","red")) +
  labs(title = "Projected Population, 2040: Albemarle") + mapTheme +
