...
interpolate_column <- function(column_name) {
...
fishnetPopulation00 <- interpolate_column('total_population')
fishnetHHunit00 <- interpolate_column('total_housing_units')
fishnetVacHH00 <- interpolate_column('total_vacant_households')
fishnetWhiteP00 <- interpolate_column('total_white')
fishnetGraduate00 <- interpolate_column('total_graduate_degree_holders')
...
dat <- 
  cbind(
    fishnet, highwayPoints_fishnet,fishnetGraduate00,fishnetHHunit00,fishnetPopulation00,fishnetVacHH00,fishnetWhiteP00, aggregatedRasters) %>%
  dplyr::select(lc_change, developed, forest, farm, wetlands, otherUndeveloped, water,
                total_population,total_graduate_degree_holders,total_housing_units,total_vacant_households,total_white, distance_highways, lagDevelopment) %>%
